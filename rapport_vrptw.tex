...
\begin{titlepage}
  ...
  \vspace{1.2cm}
  {\huge\bfseries Resolution du VRPTW par deux metaheuristiques\par}
  \vspace{0.5cm}
  ...
  \vfill
  \begin{flushleft}
  \textbf{Auteurs :} Equipe projet VRPTW \\
  \textbf{Encadrement :} Cours de recherche operationnelle / metaheuristiques \\
